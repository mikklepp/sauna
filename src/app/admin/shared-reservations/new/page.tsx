...
export default function NewSharedReservationPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      // Combine date and startTime into a DateTime
      ...
      const payload: {
        ...
        saunaId: formData.saunaId,
        date: formData.date,
        startTime: startDateTime.toISOString(),
        malesDurationHours: formData.malesDurationHours,
        femalesDurationHours: formData.femalesDurationHours,
        genderOrder: formData.genderOrder,
        isAutoGenerated: false,
        createdBy: 'admin', // In a real app, get from auth context
      };

      // Only include name and description if they have values
      ...
      <Card className="p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <select
              id="genderOrder"
              data-testid="gender-order-select"
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                data-testid="women-duration-select"
            ...
            <div>
              ...
              <select
                ...
                data-testid="men-duration-select"
